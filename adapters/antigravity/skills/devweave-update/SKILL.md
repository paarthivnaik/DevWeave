...
# Antigravity DevWeave Update Skill (`devweave-update`)
...
- **When inside an initialized repository**:
  ```text
  ✨ DevWeave Antigravity Plugin updated & repository intelligence synchronized.
  ...
  Suggested Next Commands:
    • devweave-modernization-context <WorkItemId> (to begin modernization)
    • devweave-context <WorkItemId> (to begin standard work item)
  ```
- **When outside a repository**:
  ```text
  ✨ DevWeave Antigravity Plugin updated globally.

  Plugin Version: 1.2.0 (22 active skills)

  Suggested Next Commands:
    • devweave-init (run inside a project repository to establish repository intelligence)
  ```
