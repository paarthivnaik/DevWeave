# End-to-End Request & Execution Flow: php
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\php\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: php
