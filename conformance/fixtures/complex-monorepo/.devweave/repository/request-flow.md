# End-to-End Request & Execution Flow: complex-monorepo
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\complex-monorepo\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: complex-monorepo
