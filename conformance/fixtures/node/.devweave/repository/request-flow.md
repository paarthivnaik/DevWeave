# End-to-End Request & Execution Flow: node
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\node\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: node
