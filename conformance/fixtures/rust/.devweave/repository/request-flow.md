# End-to-End Request & Execution Flow: rust
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\rust\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: rust
