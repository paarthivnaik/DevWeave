# End-to-End Request & Execution Flow: angular
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\angular\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: angular
