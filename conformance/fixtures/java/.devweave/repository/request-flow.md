# End-to-End Request & Execution Flow: java
...
"@
    ...
    Set-Content -Path (Join-Path D:\DevWeave\conformance\fixtures\java\.devweave\repository "integrations.md") @"
# Integrations & External Interfaces: java
