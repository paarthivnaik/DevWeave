...
# GitHub Copilot DevWeave Update Command (`@devweave /update`)
...
- **When inside an initialized repository**:
  ```text
  ✨ DevWeave Copilot Plugin updated & repository intelligence synchronized.
...
- **When outside a repository**:
  ```text
  ✨ DevWeave Copilot Plugin updated globally.
