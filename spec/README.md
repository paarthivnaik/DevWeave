...
- `agents/`: Agent role archetypes and capability profiles
- `policies/`: Verification, safety, security, and quality policies
- `templates/`: Work item and artifact templates
