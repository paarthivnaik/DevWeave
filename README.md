...
| **Phase 4: Branch** | `devweave-branch <ID>` | `/devweave-branch <ID>` | `/branch <ID>` | `devweave-branch <ID>` | Creates isolated Git branch with interactive name & base branch selection (`--name`, `--base`). |
